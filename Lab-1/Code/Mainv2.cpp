...
int main()
{
    ...
    displayBuckets(globalDirectory);
    // delete 113, nothing should happen
    deleteItem(32, initialFile, globalDirectory);
    displayBuckets(globalDirectory);
    // deleteItem(112, initialFile, globalDirectory);
    // deleteItem(113, initialFile, globalDirectory);
    // displayBuckets(globalDirectory);
    // delete 112, nothing should happen
    // delete 39, 2 merges should occur
